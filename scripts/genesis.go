...
var (
	...
	useStocks        = flag.Bool("use-stocks", false, "use stock markets")
...
func main() {
	...
	if *useStocks {
		fmt.Fprintf(flag.CommandLine.Output(), "Using stock markets\n")
		marketMap = mergeMarketMaps(marketMap, marketmaps.StockMarketMap)
	}
